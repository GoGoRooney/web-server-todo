...
var workerSchema = require('./schema/WorkerSchema');
var ws = new workerSchema();

worker = function getWorker(model) {
	workerVar = model;
	console.log(workerVar);
} 

ws.doCreateSchema('Liam Moore','high','', worker);
...
if (mustCreate) {
	...
	var Timeslots = mongoose.model('Timeslots',timeSlotsSchema);
